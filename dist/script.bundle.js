...
/***/ "./scripts/modules/frontend/addAnswer.js":
/*!***********************************************!*\
  !*** ./scripts/modules/frontend/addAnswer.js ***!
  \***********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_frontend_addQuestion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/frontend/addQuestion */ \"./scripts/modules/frontend/addQuestion.js\");\n/* harmony import */ var _modules_frontend_deleteFormGroup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/frontend/deleteFormGroup */ \"./scripts/modules/frontend/deleteFormGroup.js\");\n/* harmony import */ var _modules_frontend_addAnswer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/frontend/addAnswer */ \"./scripts/modules/frontend/addAnswer.js\");\n\n\n\n\nlet addQuestionButton = document.querySelector('#add-question-button');\nlet form = document.querySelector('form');\n\nif(form !== null) {\n    form.addEventListener('click', (e) => {\n        let target = e.target;\n        if (target.name === 'delete-question' || target.name === 'delete-answer') {\n            Object(_modules_frontend_deleteFormGroup__WEBPACK_IMPORTED_MODULE_1__[\"deleteFormGroup\"])(target);\n        }\n        if (target.name === 'add-answer-button') {\n            Object(_modules_frontend_addAnswer__WEBPACK_IMPORTED_MODULE_2__[\"addAnswer\"])(target);\n        }\n    });\n}\n\nif(addQuestionButton !== null) {\n    addQuestionButton.addEventListener('click', () => {\n        Object(_modules_frontend_addQuestion__WEBPACK_IMPORTED_MODULE_0__[\"addQuestion\"])();\n    });\n}\n\n//# sourceURL=webpack:///./scripts/script.js?");
